...
export const FcPayDebt: React.FC = () => {
    ...
    originData.push(
      {
        ...
        type0: store.map((item) => {
          if (item.zbKey === 'ld' && item.type === 0) {
            return item.equation
          }
        }),
        type1: store.map((item) => {
          if (item.zbKey === 'ld' && item.type === 1) {
            return item.equation
          }
        }),
        type2: store.map((item) => {
          if (item.zbKey === 'ld' && item.type === 2) {
            return item.equation
          }
        }),
      ...
      },
      {
        ...
        key: 'sd',
        type0: store.map((item) => {
          if (item.zbKey === 'sd' && item.type === 0) {
            return item.equation
          }
        }),
        type1: store.map((item) => {
          if (item.zbKey === 'sd' && item.type === 1) {
            return item.equation
          }
        }),
        type2: store.map((item) => {
          if (item.zbKey === 'sd' && item.type === 2) {
            return item.equation
          }
        }),
        score0: store.map((item) => {
      ...
      },
      {
        ...
        key: 'xjllb',
        type0: store.map((item) => {
          if (item.zbKey === 'xjllb' && item.type === 0) {
            return item.equation
          }
        }),
        type1: store.map((item) => {
          if (item.zbKey === 'xjllb' && item.type === 1) {
            return item.equation
          }
        }),
        type2: store.map((item) => {
          if (item.zbKey === 'xjllb' && item.type === 2) {
            return item.equation
          }
        }),
        score0: store.map((item) => {
      ...
      },
      {
        ...
        key: 'zcfzl',
        type0: store.map((item) => {
          if (item.zbKey === 'zcfzl' && item.type === 0) {
            return item.equation
          }
        }),
        type1: store.map((item) => {
          if (item.zbKey === 'zcfzl' && item.type === 1) {
            return item.equation
          }
        }),
        type2: store.map((item) => {
          if (item.zbKey === 'zcfzl' && item.type === 2) {
            return item.equation
          }
        }),
        score0: store.map((item) => {
      ...
      },
      {
        ...
        key: 'zbzzl',
        type0: store.map((item) => {
          if (item.zbKey === 'zbzzl' && item.type === 0) {
            return item.equation
          }
        }),
        type1: store.map((item) => {
          if (item.zbKey === 'zbzzl' && item.type === 1) {
            return item.equation
          }
        }),
        type2: store.map((item) => {
          if (item.zbKey === 'zbzzl' && item.type === 2) {
            return item.equation
          }
        }),
        score0: store.map((item) => {
      ...
      },
      {
        ...
        key: 'qsjzbl',
        type0: store.map((item) => {
          if (item.zbKey === 'qsjzbl' && item.type === 0) {
            return item.equation
          }
        }),
        type1: store.map((item) => {
          if (item.zbKey === 'qsjzbl' && item.type === 1) {
            return item.equation
          }
        }),
        type2: store.map((item) => {
          if (item.zbKey === 'qsjzbl' && item.type === 2) {
            return item.equation
          }
        }),
        score0: store.map((item) => {
      ...
      },
      {
        ...
        key: 'lszfbs',
        type0: store.map((item) => {
          if (item.zbKey === 'lszfbs' && item.type === 0) {
            return item.equation
          }
        }),
        type1: store.map((item) => {
          if (item.zbKey === 'lszfbs' && item.type === 1) {
            return item.equation
          }
        }),
        type2: store.map((item) => {
          if (item.zbKey === 'lszfbs' && item.type === 2) {
            return item.equation
          }
        }),
        score0: store.map((item) => {
